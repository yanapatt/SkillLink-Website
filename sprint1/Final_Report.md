...
| --- | --- | --- | --- |
| AccountService | createAccount | should create an account with valid data | ทดสอบการสร้างบัญชีใหม่ด้วยข้อมูลที่ครบถ้วน และเข้ารหัสรหัสผ่านก่อนบันทึกลงฐานข้อมูล |
...
| AccountService | authenticateAccount | should return null and log error if account not found | ทดสอบกรณีที่หาไม่เจอข้อมูลบัญชีจากฐานข้อมูล ถึงแม้จะมีผลลัพธ์ size=1 แต่ไม่มี node จริง ต้อง log error |