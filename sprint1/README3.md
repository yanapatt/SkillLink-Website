...
## **สรุปการประชุมและคลิปวีดีโอ Retrospective ใน Sprint ที่ 3**
   จากที่กลุ่มของเราได้มีการประชุมผ่าน google meet ระบบออนไลน์ได้มีการพูดคุยเกี่ยวกับสิ่งที่ทุกคนได้ไปทำแล้วที่ทำได้ดี และคิดวา่าสามารุปรับปรุงอะไรที่จะมาทำในPhase ถัดไปเป็นการทำให้รับรู้ถึงปัญหาที่แต่ละคนกำลังเจอทุกคนจะได้สามารถช่วยเหลือกันแก้ไขให้ดีขึ้นได้ โดยใน Phaseนี้ ทุกคนมีความเห็นว่าทุกคนสามารถรับผิดชอบงานที่ได้รับมอบหมายให้เสร็จได้ทันเวลา แต่ปัญหาที่เจอคือ ยังคงมีการสื่อสารที่ไม่ตรงกันในเรื่องของ Commit Message ทำให้เกิดความเข้าใจผิดในการรับผิดชอบงานของแต่ละ ISSUE อีกทั้งในเรื่องของการบริหารเวลาทียังบริหารได้ไม่ได้ดีพอทำให้งานเสร็จล่าช้าและในด้าน UI ในส่วนของปัญหาที่เจอคือเรื่องเวลาที่น้อยไปแล้วก็ UI มีการบัคเล็กน้อยครับ ในการแก้ไขในครั้งหน้าหรือPhase4อยากแก้ไขบัคแล้วก็ปรับแต่งให้ UI มีความสวยงามมากขึ้นจากตอนแรก และให้ตรงกับที่ได้ออกแบบไว้ใน Figma โดยอยากให้เวลาหรือระยะการทำงานมีมากขึ้นเพราะแล้วก็ในส่วนของ test case ที่ใช่สำหรับทดสอบระบบ จำนวน Test ทั้งหมดผ่านทั้งหมดไม่พบ Test ที่ล้มเหลวแล้วการทดสอบครอบคลุมทั้งกรณีที่ข้อมูลครบและไม่ครบ, การ login สำเร็จ/ไม่สำเร็จ, การโหลด/บันทึกไฟล์ โดยในส่วนของCoverage สูงมากกว่า 90% ข้อเสนอแนะข้อ test case ในครั้งถัดไป เพิ่ม test สำหรับกรณี edge case หรือเงื่อนไขที่ยังไม่ถูกทดสอบและอาจเพิ่ม integration test หรือ test ที่ simulate user flow ข้ามหลาย service แต่โดยสรุปแล้วทุกคนในกลุ่มอาจจะมีปัญหาด้านเวลาครับในครั้งหน้าอยากให้มีการวางแผนการจัดการเวลาความรับผิดชอบในงานของแต่ละคน เพื่อให้สามารถทำงานได้อย่างราบรื่นและตรงตามเวลาที่กำหนดครับ
