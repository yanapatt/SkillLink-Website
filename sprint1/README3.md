...
**แนวทางแก้ไข:** เพิ่มความถี่ในการประชุมผ่าน Discord เพื่อประสานงานและอัปเดตสถานะงาน วางแผน Scrum Meeting อย่างน้อย 2 ครั้งต่อสัปดาห์และแบ่งเวลาให้กับ UI อย่างเหมาะสม และทบทวนงานให้ตรงกับ Figma มากขึ้น แล้วเพิ่ม edge case และ integration test ใน Sprint ถัดไป
